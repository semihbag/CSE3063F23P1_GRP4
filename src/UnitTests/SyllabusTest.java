...
public class SyllabusTest {
    ...
    public void createSyllabusObject() {
        ...
        Course course1 = new Course(new Id("ATA121"), "Ataturk Ilkeleri ve Inkilap Tarihi I", 15, 1, null,courseSchedules,3);
        ataCourse = course1;
    ...
    public void conflictBetweenATAandMBG() {
        ...
        Course course2 = new Course(new Id("MBG1201"),"Introduction to Modern Biology", 15,1,null,courseSchedules1,5);
    ...
    public void addInitiallyCoursesToTheSyllabus() {
        ...
        Course course4 = new Course(new Id("MBG1201"),"Introduction to Modern Biology", 15,1,null,courseSchedules4,5);
        ...
        Course course3 = new Course(new Id("CSE1200"),"Introduction to Computer Engineering",15,1,null,courseSchedules3,4);
